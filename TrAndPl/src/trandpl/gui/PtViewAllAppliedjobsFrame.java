...
public class PtViewAllAppliedjobsFrame extends javax.swing.JFrame {
    ...
    public PtViewAllAppliedjobsFrame() {
        ...
        this.setTitle("Participants View All Applied Job Option Frame");
    ...
    private void loadAppliedJobsDetails(){
        try{
            allAppliedJobsList=ResultDAO.getAllAppliedJob(CurrentUser.getId());
            ...
            if(allAppliedJobsList.isEmpty()){
                JOptionPane.showMessageDialog(null,"You Haven't Applied Any Jobs","Applied Job Not Present",JOptionPane.INFORMATION_MESSAGE);
            }
        }
    ...
    private void initComponents() {
        ...
        btnTakeQuiz.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        ...
        jPanel1.add(btnTakeQuiz, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 470, 124, 41));
